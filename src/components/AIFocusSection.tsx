        ...
        <div className="max-w-full mx-auto mb-10">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg max-w-7xl mx-auto">
              Artificial intelligence is transforming how pharmaceutical and healthcare organizations operate - from pharma R&D to patient care, AI will impact every single process. <br />
