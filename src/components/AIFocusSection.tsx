        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="relative">
            <div className="relative h-[550px] w-full">
              ...
              {/* Connecting Line from Strategy to Center - starting from the corner of the div */}
              ...
              {/* Connecting Line from Implementation to Center - starting from the corner of the div */}
              ...
              {/* Connecting Line from Processes to Center - starting from the corner of the div */}
              ...
              {/* Connecting Line from Organizational Change to Center - starting from the corner of the div */}
