  ...
  return <section id="expertise" className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-12">
          {expertisePoints.map((point, index) => <Card key={index} className="border-green-100 shadow-sm hover:shadow-md transition-shadow duration-300">
              <CardContent className="text-gray-600 text-lg mx-auto max-w-7xl">
