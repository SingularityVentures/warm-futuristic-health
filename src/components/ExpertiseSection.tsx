      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          <div className="order-2 lg:order-1 flex h-full">
            <div className="p-6 bg-gradient-to-br from-green-50 to-white rounded-xl border border-green-100 shadow-sm h-full flex flex-col justify-between">
              <div>
                <div className="mb-6">
                  ...
                  <p className="text-lg text-gray-700 mb-4">
                    Healthcare and Life Sciences are the world's most vital industries but their high stakes create unique challenges for IT projects and new business:
                  </p>
