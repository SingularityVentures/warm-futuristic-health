...
const ServiceCard = ({ 
  ...
  return (
    <Card 
      className={`border-l-4 border-l-green-600 rounded-xl transition-all duration-300 h-full
                ${isHighlighted 
    ...
    >
      <CardContent className="p-0 h-full">
        <div className="grid md:grid-cols-[120px_1fr] items-center h-full">
          ...
          <div className="p-5 h-full flex flex-col justify-between">
            ...
            <Button 
              className="bg-green-600 hover:bg-green-700 text-white transition-colors mt-auto w-fit"
            >
              Learn more
