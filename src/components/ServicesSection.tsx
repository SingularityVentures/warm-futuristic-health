      ...
      <div className="container mx-auto px-4">
        ...
        <Tabs defaultValue="transform" className="w-full">
          ...
          <TabsContent value="transform" className="animate-fade-in mt-0">
            {/* Light background that stretches from subheading to the bottom of the content */}
            <div className="relative">
              <div className="absolute inset-0 rounded-3xl bg-green-50/70 -mt-6 -mx-4 p-8 shadow-lg" style={{ top: '-1rem', bottom: '-2rem', left: '-1rem', right: '-1rem' }}></div>
          ...
          <TabsContent value="create" className="animate-fade-in mt-0">
            {/* Light background for Create tab */}
            <div className="relative">
              <div className="absolute inset-0 rounded-3xl bg-green-50/70 -mt-6 -mx-4 p-8 shadow-lg" style={{ top: '-1rem', bottom: '-2rem', left: '-1rem', right: '-1rem' }}></div>
